...
public class CommentService {
    ...
    public List<Comment> findCommentByPostId(Long postid) { // 게시판 아이디를 통해 댓글 조회 
    ...
    public List<Comment> findCommentByUserID(Long userid){ //유저 아이디를 통해 댓글 조회 이거 데이터베이스 연동해야함.. 찾아서 manytoOne으로 하긴했는데 될지 모름....
    ...
    public void deleteComment(Long commentid) {    // 댓글을 조회하고 삭제. ?? 뭔가 이상한 내가 뭘 생각하고 만든거지
        List<Comment> existingComments = commentRepository.findByUserId(commentid);
